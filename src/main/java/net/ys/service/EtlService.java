...
public class EtlService {
    ...
    private Map<String, String> genSql(int dbType, EtlEntity entity, List<EtlField> fields) {
        ...
        if (dbType == DbType.MY_SQL.type) {
            ...
            sqlSelect = new StringBuffer("SELECT ").append(quotLeft).append(entity.getSrcTabName()).append(quotRight).append(".").append(quotLeft).append(fields.get(0).getSrcFieldName()).append(quotRight).append(" AS ").append(quotLeft).append(alias.get(0)).append(quotRight);
            for (int i = 1; i < fields.size(); i++) {
                sqlSelect.append(", ").append(quotLeft).append(entity.getSrcTabName()).append(quotRight).append(".").append(quotLeft).append(fields.get(i).getSrcFieldName()).append(quotRight).append(" AS ").append(quotLeft).append(alias.get(i)).append(quotRight);
            }
            ...
            sqlSelect = new StringBuffer("SELECT * FROM ( SELECT T1.*, ROWNUM AS ORACLE___RW FROM (SELECT ").append(quotLeft).append(entity.getSrcTabName()).append(quotRight).append(".").append(quotLeft).append(fields.get(0).getSrcFieldName()).append(quotRight).append(" AS ").append(quotLeft).append(alias.get(0)).append(quotRight);
            for (int i = 1; i < fields.size(); i++) {
                sqlSelect.append(", ").append(quotLeft).append(entity.getSrcTabName()).append(quotRight).append(".").append(quotLeft).append(fields.get(i).getSrcFieldName()).append(quotRight).append(" AS ").append(quotLeft).append(alias.get(0)).append(quotRight);
            }
            ...
            sqlSelect = new StringBuffer("SELECT ").append(quotLeft).append(entity.getSrcTabName()).append(quotRight).append(".").append(quotLeft).append(fields.get(0).getSrcFieldName()).append(quotRight).append(" ").append("AS ").append(quotLeft).append(alias.get(0)).append(quotRight);
            for (int i = 1; i < fields.size(); i++) {
                sqlSelect.append(", ").append(quotLeft).append(entity.getSrcTabName()).append(quotRight).append(".").append(quotLeft).append(fields.get(i).getSrcFieldName()).append(quotRight).append(" ").append("AS ").append(quotLeft).append(alias.get(0)).append(quotRight);
            }
    ...
    private boolean addDataStep(Connection connectionDes, String tableName, List<Map<String, Object>> data, List<EtlField> fields, int dbType) {
        ...
        if (dbType == DbType.MY_SQL.type) {
            ...
            for (EtlField field : fields) {
                sql.append("`").append(field.getDesFieldName()).append("` = ?,");
            }
